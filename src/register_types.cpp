...
void gdextension_initialize(ModuleInitializationLevel p_level)
{
	...
	if (p_level == MODULE_INITIALIZATION_LEVEL_SCENE)
	{
		...
		ClassDB::register_class<BG_GameMapDetails>();
		...
		ClassDB::register_class<BG_AudioDataDetails>();
		ClassDB::register_class<BG_AudioData>();
		ClassDB::register_class<BG_HueShiftData>();
		ClassDB::register_class<BG_BaseStat>();
		ClassDB::register_class<BG_ContentStat>();
		...
		ClassDB::register_class<BG_Formation>();
		ClassDB::register_class<BG_DefaultFormations>();
		ClassDB::register_class<BG_Band>();
		ClassDB::register_class<BG_UnitStat>();
		ClassDB::register_class<BG_UnitStatDetails>();
		ClassDB::register_class<BG_AnimationTagDetails>();
		ClassDB::register_class<BG_AnimationDetails>();
