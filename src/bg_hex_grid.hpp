...
public:
    ...
    Ref<BG_HexGameSaveData> get_nearest_attackable(const Ref<BG_Hex> &from_job_hex, const TypedArray<int> &attackable_types, const TypedArray<StringName> &dyn_types_filter, const TypedArray<BG_Band> &bands) const;
